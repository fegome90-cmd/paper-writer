...
def main():
    parser = argparse.ArgumentParser(
        description=("Europe PMC API: search, download, full text, citations & references.")
    )
    ...
    p_search.add_argument("--max_results", type=int, default=10, help="Max results (default 10)")
    ...
    if args.command == "search":
        result = search(args.query, args.max_results, args.result_type, args.cursor, args.sort)
