...
def parse_args() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Download paper from arXiv (PDF or HTML)")
    parser.add_argument("--id", type=str, required=True, help="arXiv ID (e.g., 2305.10601)")
    parser.add_argument(
        "--format",
        type=str,
        choices=["pdf", "html"],
