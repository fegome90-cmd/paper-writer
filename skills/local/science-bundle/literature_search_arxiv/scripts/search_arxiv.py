...
def parse_args() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Search arXiv API and return clean JSON")
    parser.add_argument(
        "--query",
        type=str,
    ...
    parser.add_argument("--max_results", type=int, default=10, help="Number of results to return")
    parser.add_argument(
        "--sort_by",
        type=str,
