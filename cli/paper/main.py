...
Structural refactoring PR1: parser construction extracted to parser.py,
handlers to commands/. This module retains the dispatch block and
orchestrator wiring until P1.7 (dispatch.py extraction).
"""
