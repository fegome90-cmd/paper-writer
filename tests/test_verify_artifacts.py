...
class TestDeriveCiteKey:
    ...
    def test_basic_author_year(self) -> None:
        entry = {
            "author": "Hongjin Su and Shuyang Jiang",
            "year": "2024",
    ...
    def test_comma_author_format(self) -> None:
        entry = {
            "author": "Brown, T. B. and Mann, B.",
            "year": "2020",
            "title": "Language Models are Few-Shot Learners",
        }
        assert _derive_cite_key(entry) == "brown2020language"
...
class TestParseBibKeys:
    ...
    def test_extracts_keys_and_titles(self, tmp_path: Path) -> None:
        ...
        assert result == {
            "su2024evor": "EvoR: Evolving Retrieval",
            "zhang2023repocoder": "RepoCoder",
        }
...
class TestGenerateClaimCitationAudit:
    ...
    def test_cross_references_citations(self, tmp_path: Path) -> None:
        ...
        (draft_dir / "methods.md").write_text("We follow [@chen2021humaneval].\n")
