...
checks = {
    ...
    "tests_lean_init": "cli" not in content.split("test_init_creates_scaffold")[1].split("def ")[0] if "test_init_creates_scaffold" in content else False,
    "tests_cross_project_isolation": "isolation" in content.lower() or "two.*project" in content.lower(),
